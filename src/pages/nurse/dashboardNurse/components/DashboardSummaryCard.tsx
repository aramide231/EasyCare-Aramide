...
const DashboardSummaryCard = ({
  ...
  return (
    <button
      ...
      onClick={onClick}
      className={cn(
        "relative flex flex-1 min-w-0 overflow-hidden rounded-lg text-left shadow-md transition hover:brightness-105 focus:outline-none focus-visible:ring-2 focus-visible:ring-[#573FD1] focus-visible:ring-offset-2",
        isNotification
